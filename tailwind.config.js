  ...
  theme: {
    extend: {
      colors: {
        ...
        'ui-card': 'rgba(255, 255, 255, 0.1)',
        'ui-card-dark': 'rgba(15, 23, 42, 0.6)',
        'ui-card-glass': 'rgba(255, 255, 255, 0.05)',
        'ui-border': 'transparent',
        'ui-border-light': 'transparent',
        'ui-highlight': 'rgba(0, 204, 255, 0.2)',
