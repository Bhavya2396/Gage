  ...
  theme: {
    extend: {
      colors: {
        ...
        'ui-card': 'rgba(255, 255, 255, 0.4)',
        'ui-card-dark': 'rgba(15, 23, 42, 0.95)',
        'ui-card-glass': 'rgba(255, 255, 255, 0.2)',
        'ui-border': 'rgba(255, 255, 255, 0.5)',
        'ui-border-light': 'rgba(255, 255, 255, 0.6)',
        'ui-highlight': 'rgba(0, 204, 255, 0.4)',
